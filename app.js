  ...
  onLaunch: function() {
    ...
    setTimeout(() => {
      api.getThemes().then(res => {
        ...
        this.globalData.themeBorder = 'margin:0!important;border:2rpx solid ' + res.data.style.bg_color + '!important;border-color:' + res.data.style.bg_color + '!important;border-radius:400rpx;color:' + res.data.style.bg_color + '!important;'; //themeBorder风格
    ...
    wx.login({
      success: res => {
        ...
        api.login(data).then(res => {
          ...
          that.globalData.openid = 'sns_wa_' + res.data.openid;
