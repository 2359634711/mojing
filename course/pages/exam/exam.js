...
Page({
  ...
  subScore() {
    ...
    util.request(util.apiUrl + `app/ewei_shopv2_api.php?i=${util.posId}&r=${postr}.ykt.pj&openid=${wx.getStorageSync('openid')}`, 'POST', {
      id: this.data.id,
  ...
  getTestPaper() {
    ...
    if (this.data.state == 1) {
      url = `app/ewei_shopv2_api.php?i=${util.posId}&r=${postr}.ykt.sj_select&openid=${wx.getStorageSync('openid')}`
    } else if (this.data.state == 2) {
      url = `app/ewei_shopv2_api.php?i=${util.posId}&r=${postr}.ykt.cjxq&openid=${wx.getStorageSync('openid')}`
    } else {
      url = `app/ewei_shopv2_api.php?i=${util.posId}&r=${postr}.ykt.dpj_xq&openid=${wx.getStorageSync('openid')}`
    }
  ...
  sub() {
    ...
    let this_ = this;
    util.request(util.apiUrl + `app/ewei_shopv2_api.php?i=${util.posId}&r=${postr}.ykt.sjtj&openid=${wx.getStorageSync('openid')}`, 'POST', {
